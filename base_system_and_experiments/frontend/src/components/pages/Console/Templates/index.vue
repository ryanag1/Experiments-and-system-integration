<template>
  <v-main class="mt-10 grey lighten-4">
    ...
    <dialog-call :duct="duct" :opponentId="opponentId" :fetchData="fetchData" :sender="sender" :reciever="reciever" :userId="userId" v-on:sr-change="onSRChange" ref="dlgCall"></dialog-call>
