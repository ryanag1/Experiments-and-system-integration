...
class Handler(EventHandler):
    ...
    def setup(self, handler_spec,manager):
        ...
        self.ack_interval = 2
        self.players_transform_position = "GameStage/Players/Data/Game/"
        self.user_id_url = "GameStage/Players/Data/Game/Id"
        self.players_init_transform_url = "GameStage/Players/Data/Game/Tmp"
        return handler_spec
